# File for pseudo legal, square based bitboard, rook move table generation. 
...
def get_rook_magics(blocker_sets, min_max_bits, n_tries=100000):
...
if __name__=="__main__":
	...
	database=get_rook_magics(blocker_sets, min_max_bits, n_tries=1000000)

	pickle.dump( database, open( "rook_magics.p", "wb" ) )
